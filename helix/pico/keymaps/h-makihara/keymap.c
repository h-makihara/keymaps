...
[_QWERTY] = LAYOUT( \
   ...
   */
  [_LOWER] = LAYOUT( \
      KC_TILD, KC_EXLM, JA_AT,   KC_HASH, KC_DLR,  KC_PERC,                   JA_HAT, KC_CIRC, S(KC_QUOT), KC_ASTR, KC_LPRN, KC_DEL, \
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   JIS_BSLS, S(JIS_SCLN), S(JA_LBRC), S(JA_RBRC), S(JIS_JYEN), \
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_MINS, KC_UNDS,  KC_RBRC, JA_RBRC, JIS_JYEN, \
