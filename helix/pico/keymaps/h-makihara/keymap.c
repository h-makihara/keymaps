...
[_QWERTY] = LAYOUT( \
   ...
   */
  [_LOWER] = LAYOUT( \
      KC_TILD, KC_EXLM, JA_AT,   KC_HASH, KC_DLR,  KC_PERC,                   JA_HAT, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_DEL, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_MINS, JA_HAT,  KC_LBRC, KC_RBRC, KC_BSLS, \
